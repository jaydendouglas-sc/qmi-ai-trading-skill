...
- a Python package under `src/qmi_skill`;
...
Replace this placeholder after publishing:

```text
https://github.com/<your-github-username>/qmi-ai-trading-skill
```
