<p align="center"><img src="logo.svg" alt="QMI logo" width="720"></p>
...
<p align="center"><img src="architecture.svg" alt="QMI architecture" width="100%"></p>

<p align="center"><img src="regime-map.svg" alt="QMI market regimes" width="100%"></p>

## Repository map

This edition intentionally uses a **flat repository layout** so the complete submission can be uploaded reliably from a mobile browser without losing folders.

- `SKILL.md` — canonical competition submission
- `engine.py`, `models.py`, `cli.py` — executable reference implementation
- `test_engine.py` — deterministic unit tests
- `sample-market-input.json` — example input
- `default-parameters.yaml` — parameter reference
- `DOC-*.md` — architecture, risk, Agent and evidence documentation
- `EXAMPLE-*.md` — worked safety scenarios
- `logo.svg`, `architecture.svg`, `regime-map.svg` — original visual assets

## Quick start

```bash
python -m pip install -e .
qmi-skill sample-market-input.json
```
...
- Executable reference implementation included
- Risk overrides and invalidation conditions documented
- Five deterministic tests passing
- No unsupported performance claims
- Public repository link included
